...
- On 2026-09-21 `npm run tauri build -- --debug` completed and the debug `.app` contained `scripts/local_mlx_model_readiness.py`; its macOS signature is ad hoc, so this validates bundling only and does not establish signed cutover.
